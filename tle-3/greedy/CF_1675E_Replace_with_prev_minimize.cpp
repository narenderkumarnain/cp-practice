    ...
    while(t--) {
        ...
        while(idx < n) {
            ...
            if(start != -1 && end != -1) {
                ...
                int shiftsRequired = curr - 'a';
                if(shiftsRequired > rem) {
                    int newStart = ((curr - 'a') - k);
                    start = newStart;
                    end = curr - 'a';
                    rem = 0;
                    break;
        ...
        for(int i=0;i<n;i++) {
            ...
            int currVal = currCh - 'a';

            if(start != -1 && currVal >= start && currVal <= end) {
                // replacement time
                s[i] = 'a' + start;
                continue;
            }

            if(start2 != -1 && currVal >= start2 && currVal <= end2) {
                s[i] = 'a' + start2;
                continue;
            }
        }
